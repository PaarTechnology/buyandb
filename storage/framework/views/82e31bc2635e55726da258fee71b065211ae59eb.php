...
<?php $__env->startSection('content'); ?>
    <div class="container py-5 rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
        <h2 class="text-center mb-3 headerTitle"><?php echo e(translate('privacy_policy')); ?></h2>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/themes/default/web-views/pages/privacy-policy.blade.php ENDPATH**/ ?>