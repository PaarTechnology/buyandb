        ...
        <!-- Content  -->
            <section class="col-lg-9 __customer-profile">
                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                    <h5 class="mb-0"><?php echo e(translate('profile_Info')); ?></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-end d-none d-lg-block">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" style="width:200px;min-width:0 !important">
                                    <a class="dropdown-item" href="javascript:" onclick="route_alert('<?php echo e(route('account-delete',[$customerDetail['id']])); ?>','<?php echo e(translate('want_to_delete_this_account')); ?>?')">
                                        <?php echo e(translate('delete_account')); ?>
                        ...
                        <div class="card-inner">
                            <form class="mt-3 px-sm-2 pb-2" action="<?php echo e(route('user-update')); ?>" method="post" id="profile_form"
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="profile--info mb-4">
                                    <div class="position-relative profile-img mb-3">
                                        <img id="blah" onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'" src="<?php echo e(asset('storage/app/public/profile')); ?>/<?php echo e($customerDetail['image']); ?>" alt="">
                                    ...
                                    <h5 class="text-capitalize"><?php echo e($customerDetail->f_name. ' '.$customerDetail->l_name); ?></h5>
                                </div>
                                <div class="row g-3">
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="firstName" class="mb-2 text-capitalize"><?php echo e(translate('first_name')); ?> </label>
                                        <input type="text" class="form-control" id="f_name" name="f_name"
                                                value="<?php echo e($customerDetail['f_name']); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="lastName" class="mb-2 text-capitalize"> <?php echo e(translate('last_name')); ?> </label>
                                        <input type="text" class="form-control" id="l_name" name="l_name"
                                                value="<?php echo e($customerDetail['l_name']); ?>">
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="phone" class="mb-2 text-capitalize"><?php echo e(translate('phone_number')); ?>

                                            <small class="text-primary">(* <?php echo e(translate('country_code_is_must_like_for_BD')); ?> 880)</small>
                                        </label>
                                        <input type="number" class="form-control" id="phone"
                                                name="phone" value="<?php echo e($customerDetail['phone']); ?>" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="inputEmail4" class="mb-2 text-capitalize"><?php echo e(translate('email')); ?> </label>
                                        <input type="email" class="form-control" id="account-email"
                                                value="<?php echo e($customerDetail['email']); ?>" disabled>
                                    </div>
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="si-password"class="mb-2 text-capitalize"><?php echo e(translate('new_password')); ?></label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="newPass" class="mb-2 text-capitalize"><?php echo e(translate('confirm_password')); ?> </label>
                                        <div class="password-toggle rtl">
    ...
    <script>
        ...
        function checkPasswordMatch() {
            ...
            if (confirmPassword == "") {
                ...
                $("#message").html("<?php echo e(translate('please_ReType_Password')); ?>");
                ...
                $("#message").html("<?php echo e(translate('passwords_do_not_match')); ?>!");
                $("#message").attr("style", "color:red");
            } else if (confirmPassword.length <= 6) {
                $("#message").html("<?php echo e(translate('password_Must_Be_6_Character')); ?>");
                $("#message").attr("style", "color:red");
            } else {

                $("#message").html("<?php echo e(translate('passwords_match')); ?>.");
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/themes/default/web-views/users-profile/user-account.blade.php ENDPATH**/ ?>