<style>
    ...
    @media  screen and (min-width: 768px) and (max-width: 991px) {
        ...
        .category-menu-toggle-btn-text,.navbar-expand-md .navbar-nav .nav-item > a,.navbar-expand-md .navbar-nav .btn.dropdown-toggle,.navbar-expand-md .navbar-nav .nav-item{
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu"  >
            <div class="container px-10px">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                        ...
                        <li class="nav-item <?php echo e(!request()->is('/')?'dropdown':''); ?>">
                            ...
                            <a class="nav-link dropdown-toggle category-menu-toggle-btn <?php echo e(Session::get('direction') === "rtl" ? 'pr-0' : 'pl-0'); ?>"
                               href="javascript:void()">
                                <svg width="calc(1.2vw)" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav align-items-md-center" style="<?php echo e(Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/buyandb/public_html/resources/themes/default/layouts/front-end/partials/_header.blade.php ENDPATH**/ ?>