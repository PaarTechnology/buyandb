...
<!-- Content -->
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="card">
                        <h5 class="p-3 m-0 bg-light"><?php echo e(translate('product_Section')); ?></h5>
                        <div class="px-3 py-4">
                            <div class="row gy-1">
                                <div class="col-sm-6">
                                    <div class="input-group d-flex justify-content-end" >
                                        <select name="category" id="category" class="form-control js-select2-custom w-100" title="select category" onchange="set_category_filter(this.value)">
                                            ...
                                            <option value="<?php echo e($item->id); ?>" <?php echo e($category==$item->id?'selected':''); ?>><?php echo e($item->defaultName); ?></option>
                                    ...
                                    <form class="">
                                        ...
                                        <div class="input-group-overlay input-group-merge input-group-custom">
                                            ...
                                            <input id="search" autocomplete="off" type="text" value="<?php echo e($keyword?$keyword:''); ?>"
                                                    name="search" class="form-control search-bar-input" placeholder="<?php echo e(translate('search_by_name_or_sku')); ?>"
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-end mb-3">
                                <button type="button" class="btn btn-outline--primary d-flex align-items-center gap-2" onclick="view_all_hold_orders()">
                                    ...
                                    <span class="badge badge-danger rounded-circle total_hold_orders">
                                        ...
                                        ?>
                                        <?php echo e($view_all_hold_orders); ?>
                            ...
                            <div class="form-group d-flex gap-2">
                                ...
                                <select onchange="customer_change(this.value);" id='customer' name="customer_id" data-placeholder="Walking Customer" class="js-example-matcher form-control form-ellipsis">
                                    <option value="0" <?php echo e($user_id == 0 ? 'selected':''); ?>><?php echo e(translate('walking_customer')); ?></option>
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($customer->id); ?>" <?php echo e($user_id == $customer->id ? 'selected':''); ?>><?php echo e($customer->f_name); ?> <?php echo e($customer->l_name); ?> (<?php echo e($customer->phone); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div id="cart-summary">
                                <?php echo $__env->make('admin-views.pos._cart-summary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label" ><?php echo e(translate('email')); ?><span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>"  placeholder="<?php echo e(translate('ex')); ?>: ex@example.com" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(translate('country')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="country" class="form-control" value="<?php echo e(old('country')); ?>"  placeholder="<?php echo e(translate('country')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(translate('city')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="city" class="form-control" value="<?php echo e(old('city')); ?>"  placeholder="<?php echo e(translate('city')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(translate('zip_code')); ?> <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" name="zip_code" class="form-control" value="<?php echo e(old('zip_code')); ?>"  placeholder="<?php echo e(translate('zip_code')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <button class="btn btn--primary" onclick="coupon_discount();"
                            data-dismiss="modal"><?php echo e(translate('submit')); ?></button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="type" id="type_ext_dis" class="form-control">
                            <option value="amount" <?php echo e(isset($discount_type) && $discount_type == 'amount' ? 'selected' : ''); ?>><?php echo e(translate('amount')); ?>

                            </option>
                            <option value="percent" <?php echo e(isset($discount_type) && $discount_type == 'percent' ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        <button class="btn btn--primary" onclick="extra_discount()" data-dismiss="modal"><?php echo e(translate('submit')); ?></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="short-cut-keys" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(translate('short_cut_keys')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <span><?php echo e(translate('to_click_order')); ?> : alt + O</span><br>
                    <span><?php echo e(translate('to_click_payment_submit')); ?> : alt + S</span><br>
                    <span><?php echo e(translate('to_close_payment_submit')); ?> : alt + Z</span><br>
                    <span><?php echo e(translate('to_click_cancel_cart_item_all')); ?> : alt + C</span><br>
                    <span><?php echo e(translate('to_click_add_new_customer')); ?> : alt + A</span> <br>
                    <span><?php echo e(translate('to_submit_add_new_customer_form')); ?> : alt + N</span><br>
                    <span><?php echo e(translate('to_click_short_cut_keys')); ?> : alt + K</span><br>
                    <span><?php echo e(translate('to_print_invoice')); ?> : alt + P</span> <br>
                    <span><?php echo e(translate('to_cancel_invoice')); ?> : alt + B</span> <br>
                    <span><?php echo e(translate('to_focus_search_input')); ?> : alt + Q</span> <br>
                    <span><?php echo e(translate('to_click_extra_discount')); ?> : alt + E</span> <br>
                    <span><?php echo e(translate('to_click_coupon_discount')); ?> : alt + D</span> <br>
                    <span><?php echo e(translate('to_click_clear_cart')); ?> : alt + X</span> <br>
                    <span><?php echo e(translate('to_click_new_order')); ?> : alt + R</span> <br>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function view_all_hold_orders(action = null)
    {
        ...
        $.post({
            url: "<?php echo e(route('admin.pos.view-all-hold-orders')); ?>",
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
    ...
    function cancel_customer_order(cart_id)
    {
        ...
        $.post({
            url: "<?php echo e(route('admin.pos.cancel-customer-order')); ?>",
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                cart_id: cart_id,
            },
...
<script>
        ...
        $('.input-number').change(function () {
            ...
            if (valueCurrent >= minValue) {
                ...
                Swal.fire({
                    ...
                    text: "<?php echo e(translate('Sorry_the_minimum_value_was_reached')); ?>"
                });
    ...
    function getVariantPrice(type = null) {
        if ($('#add-to-cart-form input[name=quantity]').val() > 0 && checkAddToCartValidity()) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('admin.pos.variant_price')); ?>'+(type ? '?type='+type : ''),
                ...
                success: function (data) {
                    ...
                    if (data.quantity <= 0) {
                        ...
                        $('.stock-status-in-quick-view').html(`<i class="tio-checkmark-circle-outlined"></i> <?php echo e(translate('stock_out')); ?>`);
                    }else{
                        $('.stock-status-in-quick-view').removeClass('text-danger').addClass('text-success');
                        $('.stock-status-in-quick-view').html(`<i class="tio-checkmark-circle-outlined"></i> <?php echo e(translate('in_stock')); ?>`);
                    }

                    if (data.in_cart_status == 0) {
                        $('.quick-view-modal-add-cart-button').text("<?php echo e(translate('add_to_cart')); ?>");
                        ...
                        $('.quick-view-modal-add-cart-button').text("<?php echo e(translate('update_to_cart')); ?>");
                        if (type == null) {
        ...
        if (checkAddToCartValidity()) {
            ...
            $.post({
                ...
                success: function (data) {
                    ...
                    if (data.data == 1) {
                        $('#cart-summary').empty().html(data.view);
                        toastr.success('<?php echo e(translate("cart_updated")); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: "<?php echo e(translate('Cart')); ?>",
                            text: '<?php echo e(translate("sorry_product_is_out_of_stock.")); ?>'
                        });
                        return false;
                    }
                    $('.call-when-done').click();

                    toastr.success('<?php echo e(translate("item_has_been_added_in_your_cart")); ?>!', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                    $('#cart').empty().html(data.view);
...
<script>
    function edit_customer_modal()
    {
        ...
        $.post({
            url: "<?php echo e(route('admin.pos.customer-edit')); ?>",
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
...
<script>
    ...
    function empty_alert_show() {
        toastr.warning('<?php echo e(translate("Cart_is_empty")); ?>!', {
            CloseButton: true,
            ProgressBar: true
        });
    }
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/views/admin-views/pos/index.blade.php ENDPATH**/ ?>