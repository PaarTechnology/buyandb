<?php $__env->startSection('title',translate('my_Wishlists')); ?>
        ...
        <!-- Content  -->
            <section class="col-lg-9 __customer-profile" >
                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                    <h5 class="mb-0"><?php echo e(translate('wishlist')); ?></h5>
                ...
                <input type="hidden" id="wishlist_paginated_page" value="<?php echo e(request('page')); ?>" >
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/themes/default/web-views/users-profile/account-wishlist.blade.php ENDPATH**/ ?>