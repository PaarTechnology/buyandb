                ...
                <div class="card __card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            <h5 class="mb-0"><?php echo e(translate('coupons')); ?></h5>
                                ...
                                <div class="ticket-box">
                                    <div class="ticket-start">
                                        ...
                                        <?php if($item->coupon_type == "free_delivery"): ?>
                                            <img width="30" src="<?php echo e(asset('public/assets/front-end/img/icons/bike.png')); ?>" alt="">
                                        <?php elseif($item->coupon_type != "free_delivery" && $item->discount_type == "percentage"): ?>
                                            <img width="30" src="<?php echo e(asset('public/assets/front-end/img/icons/fire.png')); ?>" alt="">
                                        <?php elseif($item->coupon_type != "free_delivery" && $item->discount_type == "amount"): ?>
                                            <img width="30" src="<?php echo e(asset('public/assets/front-end/img/icons/dollar.png')); ?>" alt="">
                                        <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <?php echo e(($item->discount_type == 'percentage')? $item->discount.'% Off':\App\CPU\Helpers::currency_converter($item->discount)); ?>
                                    ...
                                    <div class="ticket-end">
                                        <button class="ticket-welcome-btn couponid couponid-<?php echo e($item->code); ?>" onclick="click_to_copy_coupon('<?php echo e($item->code); ?>')"><?php echo e($item->code); ?></button>
                                        ...
                                        <p class="m-0"><?php echo e(translate('available_from_minimum_purchase')); ?> <?php echo e(\App\CPU\Helpers::currency_converter($item->min_purchase)); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php if(count($coupons) == 0): ?>
                                <div class="col-12">
                                    <div class="text-center py-5 text-capitalize">
                                        <img src="<?php echo e(asset('public/assets/front-end/img/icons/coupon.svg')); ?>" alt="" class="mb-4" width="70">
                                        <h5 class="fs-14"><?php echo e(translate('no_Coupon_Found')); ?>!</h5>
                                    </div>
                                </div>
                            <?php endif; ?>

                            <div class="col-md-12 mt-2 empty"><?php echo e($coupons->links()); ?></div>
                        </div>
                    </div>
                </div>
            </section>
...
function click_to_copy_coupon(copied_text) {
    navigator.clipboard.writeText(copied_text)
        .then(function () {
            toastr.success("<?php echo e(translate('successfully_copied')); ?>");
        ...
        .catch(function (error) {
            toastr.error("<?php echo e(translate('copied_failed')); ?>");
        });
}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/themes/default/web-views/users-profile/coupons.blade.php ENDPATH**/ ?>