<html>
    <table>
        <thead>
            <tr>
                <th style="font-size: 18px"><?php echo e(translate('seller_List')); ?></th>
            </tr>
            <tr>

                <th><?php echo e(translate('seller_Analytics')); ?> -</th>
                <th></th>
                <th>
                        <?php echo e(translate('total_Seller')); ?> - <?php echo e(count($data['sellers'])); ?>

                    <br>
                        <?php echo e(translate('active_Sellers ')); ?> - <?php echo e($data['active']); ?>

                    <br>
                        <?php echo e(translate('inactive_Sellers ')); ?> - <?php echo e($data['inactive']); ?>
            ...
            <tr>
                ...
                <td> <?php echo e(translate('seller_Name')); ?></td>
...
<?php /**PATH /home/buyandb/public_html/resources/views/file-exports/seller-list.blade.php ENDPATH**/ ?>