<div class="modal fade" id="refundModal<?php echo e($id); ?>" tabindex="-1" aria-labelledby="refundRequestModalLabel" aria-hidden="true">
            ...
            <div class="modal-body d-flex flex-column gap-3">
                            ...
                            <?php if(isset($order_details->product)): ?>
                                ...
                                <div class="media-body">
                                    ...
                                    <?php if($order_details->variant): ?>
                                        <div><small class="text-muted"><?php echo e(translate('variant')); ?> : <?php echo e($detail->variant); ?></small></div>
                                    <?php endif; ?>

                                    <div><small class="text-muted"><?php echo e(translate('qty')); ?> : <?php echo e($detail->qty); ?></small></div>
                                    ...
                                    <div><small class="text-muted"><?php echo e($order_details->created_at->format('d M Y, h:i a')); ?></small></div>
                                </div>
                            <?php else: ?>
                                <div class="media-body">
                ...
                <div class="border rounded bg-white">
                    <div class="p-3 fs-12 d-flex flex-column gap-2">
                        <div class="d-flex justify-content-between gap-2">
                            ...
                            <div><?php echo e(\App\CPU\Helpers::currency_converter($order_details->price)); ?></div>
                        </div>
                        <div class="d-flex justify-content-between gap-2">
                            <div class="text-muted text-capitalize"><?php echo e(translate('product_discount')); ?></div>
                            <div>-<?php echo e(\App\CPU\Helpers::currency_converter($order_details->discount)); ?></div>
                        </div>
                        <div class="d-flex justify-content-between gap-2">
                            <div class="text-muted">vat/tax</div>
                            <div><?php echo e(\App\CPU\Helpers::currency_converter($order_details->tax)); ?></div>
                        </div>
                        <?php
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            ...
                            <div><?php echo e(\App\CPU\Helpers::currency_converter($subtotal)); ?></div>
                        </div>
                        <div class="d-flex justify-content-between gap-2">
                            <div class="text-muted text-capitalize"><?php echo e(translate('coupon_discount')); ?></div>
                            <div> -<?php echo e(\App\CPU\Helpers::currency_converter($coupon_discount)); ?></div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between gap-2 border-top py-2 px-3 fs-12">
                        <div class="text-muted font-weight-bold text-capitalize"><?php echo e(translate('total_refundable_amount')); ?></div>
                        <div class="font-weight-bold"><?php echo e(\App\CPU\Helpers::currency_converter($refund_amount)); ?></div>
                    </div>
                </div>
                <!-- form submit  -->
                <form action="<?php echo e(route('refund-store')); ?>"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="collapse" id="collapseExample">
                        ...
                        <textarea rows="4" class="form-control" name="refund_reason" placeholder="<?php echo e(translate('write_here')); ?>..."></textarea>
                    </div>
                    ...
                    <div class="mt-3 d-flex justify-content-end">
                        <button type="submit" class="btn btn--primary text-capitalize"><?php echo e(translate('send_request')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/buyandb/public_html/resources/themes/default/layouts/front-end/partials/modal/_refund.blade.php ENDPATH**/ ?>