<?php $__env->startSection('title',translate('My_Support_Tickets')); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="modal-header">
                    <div class="row">
                        <div class="col-md-12"><h5
                                class="modal-title font-nameA "><?php echo e(translate('submit_new_ticket')); ?></h5></div>
                        <div class="col-md-12 text-black mt-3">
                            <span><?php echo e(translate('you_will_get_response')); ?>.</span>
                        </div>
                    </div>
                </div>
                <div class="modal-body">
                    <form class="mt-3" method="post" action="<?php echo e(route('ticket-submit')); ?>" id="open-ticket" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="firstName"><?php echo e(translate('subject')); ?></label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="">
                                    <label class="" for="inlineFormCustomSelect"><?php echo e(translate('type')); ?></label>
                                    <select class="custom-select " id="ticket-type" name="ticket_type" required>
                                        <option
                                            value="Website problem"><?php echo e(translate('website_problem')); ?></option>
                                        <option value="Partner request"><?php echo e(translate('partner_request')); ?></option>
                                        <option value="Complaint"><?php echo e(translate('complaint')); ?></option>
                                        <option
                                            value="Info inquiry"><?php echo e(translate('info_inquiry')); ?> </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="">
                                    <label class="" for="inlineFormCustomSelect"><?php echo e(translate('priority')); ?></label>
                                    <select class="form-control custom-select" id="ticket-priority"
                                            name="ticket_priority" required>
                                        <option value><?php echo e(translate('choose_priority')); ?></option>
                                        <option value="Urgent"><?php echo e(translate('urgent')); ?></option>
                                        <option value="High"><?php echo e(translate('high')); ?></option>
                                        <option value="Medium"><?php echo e(translate('medium')); ?></option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="detaaddressils"><?php echo e(translate('describe_your_issue')); ?></label>
                                <textarea class="form-control" rows="6" id="ticket-description"
                                          name="ticket_description"></textarea>
                            </div>
                        </div>

                        <label class="" for="inlineFormCustomSelect"><?php echo e(translate('Attachment')); ?></label>
                        ...
                        <div class="modal-footer p-0 border-0">
                            ...
                            <button type="submit" class="btn btn--primary"><?php echo e(translate('submit_a_ticket')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="container py-4 rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                ...
                <div class="card __card h-100">
                    <div class="p-md-3">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            <h5 class="mb-0"><?php echo e(translate('support_ticket')); ?></h5>
                            <button type="submit" class="btn btn--primary float-<?php echo e(Session::get('direction') === "rtl" ? 'left' : 'right'); ?>" data-toggle="modal" data-target="#open-ticket">
                                <?php echo e(translate('add_new_ticket')); ?>

                            </button>
                        </div>
                        <?php if($supportTickets->count() >0): ?>
                            <div class="table-responsive">
                                <table class="table mb-0 __table-2 fs-13">
                                    <thead class="thead-light">
                                        <tr>
                                            <th class="border-0">
                                                <span class="d-block"><?php echo e(translate('topic')); ?></span>
                                            </th>
                                            <th class="border-0">
                                                <span class="d-block"><?php echo e(translate('submition_date')); ?></span>
                                            </th>
                                            <th class="border-0">
                                                <span class="d-block"><?php echo e(translate('type')); ?></span>
                                            </th>
                                            <th class="border-0">
                                                <span class="d-block">
                                            ...
                                            <th class="border-0 text-center">
                                                <span class="d-block"><?php echo e(translate('action')); ?> </span>
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $supportTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><span><?php echo e(translate($ticket['type'])); ?></span></td>
                                                <td>
                                                    <span class="badge __badge rounded-full <?php echo e($ticket['status']=='open' ? 'badge-warning': 'badge-danger'); ?>">
                                                ...
                                                <td>
                                                    <div class="btn--container flex-nowrap justify-content-center">
                                                        ...
                                                        <button class="__action-btn btn-shadow rounded-full text-danger marl delete-ticket-by-modal" data-link="<?php echo e(route('support-ticket.delete',['id'=>$ticket->id])); ?>">
                                                            <i class="czi-trash"></i>
                                                        </button>
                                                    </div>
                    ...
                    <?php if($supportTickets->count() <=0): ?>
                        <div class="text-center pt-3 text-capitalize">
                            <img src="<?php echo e(asset('public/assets/front-end/img/icons/nodata.svg')); ?>" alt="" width="70">
                            <h5 class="fs-14 mt-4"><?php echo e(translate('no_ticket_found')); ?>!</h5>
                        </div>
                    <?php endif; ?>
                </div>
            </section>
        ...
        <div class="d-flex flex-column gap-3 d-md-none">
            <?php $__currentLoopData = $supportTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white border rounded p-3 shadow-sm" onclick="location.href='<?php echo e(route('support-ticket.index',$ticket['id'])); ?>'">
                <div class="d-flex justify-content-between gap-2 align-items-end">
                    <div class="d-flex flex-column gap-1 fs-12">
                        <div class="d-flex gap-2">
                            <div class="text-muted"><?php echo e(translate('topic')); ?> :</div>
                            <div><?php echo e($ticket['subject']); ?></div>
                        </div>
                        <div class="d-flex gap-2">
                            <div class="text-muted"><?php echo e(translate('submition_date')); ?> :</div>
                            <div><?php echo e(Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$ticket['created_at'])->format('Y-m-d h:i A')); ?></div>
                        </div>
                        <div class="d-flex gap-2">
                            <div class="text-muted"><?php echo e(translate('type')); ?> :</div>
                            <div><?php echo e(translate($ticket['type'])); ?></div>
                        </div>
                        <div class="d-flex gap-2">
                            <div class="text-muted"><?php echo e(translate('status')); ?> :</div>
                            <div>
                                <span class="badge __badge rounded-full <?php echo e($ticket['status']=='open' ? 'badge-warning': 'badge-danger'); ?>">
                                    <?php echo e(translate($ticket['status'])); ?>
                    ...
                    <div>
                        <a class="__action-btn btn-shadow rounded-full text-danger stopPropagation" href="javascript:"
                            onclick="Swal.fire({
                                title: '<?php echo e(translate('do_you_want_to_delete_this')); ?>?',
                                showDenyButton: true,
                                ...
                                denyButtonText: `<?php echo e(translate('Do_not_delete')); ?>`,
                                }).then((result) => {
                                if (result.value) {
                                Swal.fire(`<?php echo e(translate('deleted!')); ?>`, '', 'success')
                                location.href='<?php echo e(route('support-ticket.delete',['id'=>$ticket->id])); ?>';
                                } else{
                                Swal.fire(`<?php echo e(translate('cancelled')); ?>`, '', 'info')
                                }
            ...
            <?php if($supportTickets->count() <=0): ?>
                <div class="text-center pt-3 text-capitalize">
                    <img src="<?php echo e(asset('public/assets/front-end/img/icons/address.svg')); ?>" alt="" width="70">
                    <h5 class="fs-14 mt-2"><?php echo e(translate('no_address_found')); ?>!</h5>
                </div>
            <?php endif; ?>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5">
                    <div class="text-center">
                        <img src="<?php echo e(asset('/public/assets/front-end/img/icons/ticket-delete.png')); ?>" alt="">
                        <h6 class="font-semibold mt-3 mb-1"><?php echo e(translate('Delete_this_ticket')); ?>?</h6>
                        <p class="mb-4">
                            <small><?php echo e(translate('This_ticket_will_be_removed_from_this_list')); ?></small>
                        </p>
                    </div>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/themes/default/web-views/users-profile/account-tickets.blade.php ENDPATH**/ ?>