<?php $__env->startSection('title',translate('Seller Apply')); ?>
...
<div class="container py-5 rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
    ...
    <h3 class="mb-3 text-center"> <?php echo e(translate('Shop')); ?> <?php echo e(translate('Application')); ?></h3>
    <form class="__shop-apply" action="<?php echo e(route('shop.apply')); ?>" id="form-id" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card __card mb-3">
            <div class="card-header">
                <h5 class="card-title m-0">
                    ...
                    <?php echo e(translate('seller_Info')); ?>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" id="exampleFirstName" name="f_name" value="<?php echo e(old('f_name')); ?>" placeholder="<?php echo e(translate('first_name')); ?>" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" id="exampleLastName" name="l_name" value="<?php echo e(old('l_name')); ?>" placeholder="<?php echo e(translate('last_name')); ?>" required>
                    </div>
                    <div class="col-sm-6 mt-4">
                        <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(translate('email_address')); ?>" required>
                    </div>
                    <div class="col-sm-6"><small class="text-danger">( * <?php echo e(translate('country_code_is_must_like_for_BD')); ?> 880 )</small>
                        <input type="number" class="form-control form-control-user" id="exampleInputPhone" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(translate('phone_number')); ?>" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="password" class="form-control form-control-user" minlength="6" id="exampleInputPassword" name="password" placeholder="<?php echo e(translate('password')); ?>" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="password" class="form-control form-control-user" minlength="6" id="exampleRepeatPassword" placeholder="<?php echo e(translate('repeat_password')); ?>" required>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="custom-file mt-3">
                            ...
                            <label class="custom-file-label" for="customFileUpload"><?php echo e(translate('upload_image')); ?></label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card __card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-sm-6 ">
                        <input type="text" class="form-control form-control-user" id="shop_name" name="shop_name" placeholder="<?php echo e(translate('shop_name')); ?>" value="<?php echo e(old('shop_name')); ?>" required>
                    </div>
                    <div class="col-sm-6">
                        <textarea name="shop_address" class="form-control" id="shop_address"rows="1" placeholder="<?php echo e(translate('shop_address')); ?>"><?php echo e(old('shop_address')); ?></textarea>
                    </div>
                    <div class="col-sm-6">
                        <div class="pb-3">
                            <center>
                        ...
                        <div class="form-group mb-0">
                            <div class="custom-file">
                                <input type="file" name="logo" id="LogoUpload" class="custom-file-input"
                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label" for="LogoUpload"><?php echo e(translate('upload_logo')); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="BannerUpload"><?php echo e(translate('upload_Banner')); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row py-2">
                            ...
                            <div class="col-6 input-icons mb-2 w-100 rounded bg-white">
                                <a onclick="javascript:re_captcha();"  class="d-flex align-items-center align-items-center">
                                    <img src="<?php echo e(URL('/seller/auth/code/captcha/1?captcha_session_id=default_recaptcha_id_seller_regi')); ?>" class="rounded __h-40" id="default_recaptcha_id">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-0 d-flex flex-wrap justify-content-between">
                            <label class="form-group mb-3 d-flex align-items-center flex-grow-1">
                                ...
                                <span class="mb-4px d-block w-0 flex-grow pl-1">
                                    <span><?php echo e(translate('i_agree_to_Your_terms')); ?></span>
                                    <a class="font-size-sm" target="_blank" href="<?php echo e(route('terms')); ?>">
                                        <?php echo e(translate('terms_and_condition')); ?>
                        ...
                        <button type="submit" class="btn btn--primary btn-user btn-block" id="apply" disabled><?php echo e(translate('apply_Shop')); ?> </button>
                        <div class="text-center">
                            <a class="small"  href="<?php echo e(route('seller.auth.login')); ?>"><?php echo e(translate('already_have_an_account?_login.')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buyandb/public_html/resources/views/seller-views/auth/register.blade.php ENDPATH**/ ?>